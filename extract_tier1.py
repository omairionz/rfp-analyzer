...
TIER1_SYSTEM = """You are extracting structured data from a federal government RFP.
...
- fields_inferred (list of field names you had to infer rather than read directly)
"""
